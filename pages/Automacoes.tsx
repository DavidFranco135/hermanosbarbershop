...
// ─────────────────────────────────────────────────────────────
// Automações de Marketing — Hermanos Barbershop
...
const Automacoes: React.FC = () => {
  ...
  const [cfg3, setCfg3] = useState({ ativo: false, desconto: 10, mensagem: '🎉 Feliz Aniversário, {{nome}}! Você tem {{desconto}}% de desconto essa semana na Hermanos Barbershop. Agende agora!' });
    ...
    <div className={`min-h-screen ${bg}`}>
      <div className="max-w-4xl mx-auto p-6 space-y-6 pb-20">
        ...
        >
          ...
          <div className={`p-4 rounded-2xl border text-sm italic ${isDark ? 'border-white/10 bg-white/3 text-zinc-300' : 'border-zinc-200 bg-zinc-50 text-zinc-600'}`}>
            💬 "🎉 Feliz Aniversário, João! A Hermanos Barbershop te dá 10% de desconto no corte essa semana."
          </div>
          <div className="flex items-center gap-3">
