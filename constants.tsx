...
export const CONFIG_LOJA: ShopConfig = {
  name: "Hermanos Barbershop",
  description: "Referência em Manilha, Itaboraí. Tradição, estilo e precisão em cada corte. Um espaço pensado para o homem moderno que valoriza qualidade e bem-estar.",
  aboutTitle: "Nossa História",
  aboutText: "A Hermanos nasceu da paixão pelo cuidado masculino e pelo respeito à tradição da barbearia clássica. Cada detalhe do nosso espaço foi pensado para oferecer uma experiência única em Manilha, Itaboraí.",
  address: "Av. Milton Rodrigues da Rocha, 144",
  city: "Itaboraí",
  state: "RJ",
  whatsapp: "5521967018171",
  instagram: "@_hermanosbarbershop",
  ...
  locationUrl: "https://maps.google.com/?q=Av.+Milton+Rodrigues+da+Rocha,+144,+Manilha,+Itaborai,+RJ",
  openingTime: "08:00",
  closingTime: "20:00",
  email: "contato@hermanosbarbershop.com.br",
